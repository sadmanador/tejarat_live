    ...
    <div class="intro-carousel">
        ...
        <div class="intro-content">
            <div class="slider-images">
                <img src="<?= asset('img/exports/agri-veges.jpg') ?>" alt="">
            </div>
        ...
        <div class="intro-content">
            <div class="slider-images">
                <img src="<?= asset('img/exports/seafood-market.jpg') ?>" alt="">
            </div>
            <div class="slider-content">
                <div class="container">
                    <div class="row">
        ...
        <div class="intro-content">
            <div class="slider-images">
                <img src="<?= asset('img/exports/seafood-crab.jpg') ?>" alt="">
            </div>
            <div class="slider-content">
                <div class="container">
                    <div class="row">
        ...
        <div class="intro-content">
            <div class="slider-images">
                <img src="<?= asset('img/exports/warehouse of trucks-08.jpg') ?>" alt="">
            </div>
            <div class="slider-content">
                <div class="container">
                    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="project-details">
                    <embed src="<?= asset('img/Tejaratprofile.pdf') ?>#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf"
...
<div class="card-container">
    <div class="item-card">
        <div class="img-container">
            <img src="<?= asset('img/exports/items/mango.png') ?>" alt="">
        </div>
    ...
    <div class="item-card">
        <div class="img-container">
            <img src="<?= asset('img/exports/items/jackfruit.jpg') ?>" alt="">
        </div>
        <div class="card-details">
    ...
    <div class="item-card">
        <div class="img-container">
            <img src="<?= asset('img/exports/items/potato.jpg') ?>" alt="">
        </div>
        <div class="card-details">
    ...
    <div class="item-card">
        <div class="img-container">
            <img src="<?= asset('img/exports/items/Cauliflower.png') ?>" alt="">
        </div>
        <div class="card-details">
    ...
    <div class="item-card">
        <div class="img-container">
            <img src="<?= asset('img/exports/items/banana.jpg') ?>" alt="">
        </div>
        <div class="card-details">
...
<div class="card-container">
    <div class="item-card">
        <div class="img-container">
            <img src="<?= asset('img/exports/items/beef.jpg') ?>" alt="">
        </div>
        <div class="card-details">
    ...
    <div class="item-card">
        <div class="img-container">
            <img src="<?= asset('img/exports/items/intestine.jpeg') ?>" alt="">
        </div>
        <div class="card-details">
    ...
    <div class="item-card">
        <div class="img-container">
            <img src="<?= asset('img/exports/items/gallstone.jpg') ?>" alt="">
        </div>
        <div class="card-details">
...
<div class="card-container">
    <div class="item-card">
        <div class="img-container">
            <img src="<?= asset('img/exports/items/crab.jpg') ?>" alt="">
        </div>
        <div class="card-details">
    ...
    <div class="item-card">
        <div class="img-container">
            <img src="<?= asset('img/exports/items/shrimp.jpg') ?>" alt="">
        </div>
        <div class="card-details">
    ...
    <div class="item-card">
        <div class="img-container">
            <img src="<?= asset('img/exports/items/eel.jpg') ?>" alt="">
        </div>
        <div class="card-details">
    ...
    <div class="item-card">
        <div class="img-container">
            <img src="<?= asset('img/exports/items/oyster.jpg') ?>" alt="">
        </div>
        <div class="card-details">
    ...
    <div class="item-card">
        <div class="img-container">
            <img src="<?= asset('img/exports/items/prawn.jpg') ?>" alt="">
        </div>
        <div class="card-details">
...
<div>
    <img src="<?= asset('img/exports/modern-creative-communication-internet-network-connect-smart-city.jpg') ?>" alt="">
</div> -->
